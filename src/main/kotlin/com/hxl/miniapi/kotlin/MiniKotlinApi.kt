...
class MiniKotlinApi(private val miniContext: MiniContext) {
    private fun createMappingInfo(url: String, kotlinRequestApi: KotlinRequestApi.() -> Unit, httpMethod: HttpMethod):MappingInfo{
        return  MappingInfo().apply {
            this.instance =MappingInstanceWrapper(miniContext,kotlinRequestApi)
            this.httpMethod =httpMethod
            this.method =this.instance::class.java.getDeclaredMethod("handler",HttpRequest::class.java,HttpResponse::class.java)
